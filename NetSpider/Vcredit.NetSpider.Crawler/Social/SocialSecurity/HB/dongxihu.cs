...
{
    public class dongxihu : ISocialSecurityCrawler
    {
        #region 公共变量
        ...
        string baseUrl = "https://111.175.187.34:9236/grws/";
        string socialCity = "hb_dongxihu";
        #endregion
        ...
        public SocialSecurityQueryRes SocialSecurityQuery(SocialSecurityReq socialReq)
        {
            ...
            try
            {
                ...
                if (rowCount > 1)
                {
                    ...
                    httpResult = httpHelper.GetHtml(httpItem);  //东西湖地区社保翻页请求无效，无法查询详单信息
