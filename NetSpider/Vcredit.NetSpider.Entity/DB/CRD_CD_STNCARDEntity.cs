...
{
	#region CRD_CD_STNCARDEntity

	/// <summary>
	/// CRD_CD_STNCARDEntity object for NHibernate mapped table 'CRD_CD_STNCARD'.
	/// </summary>
	public class CRD_CD_STNCARDEntity
	{
        ...
        //public virtual string OverdueRecordEndMonth{get; set;}
		 ...
		 /// 
		 /// </summary>
		public virtual int ? OverdraftOver60Cyc{get; set;}
		 /// <summary>
		 /// 
		 /// </summary>
		public virtual int ? OverdraftOver90Cyc{get; set;}
	}
	#endregion
}