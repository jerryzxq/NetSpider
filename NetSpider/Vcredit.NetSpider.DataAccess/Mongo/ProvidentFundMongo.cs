...
{
    public class ProvidentFundMongo
    {
        BaseMongo baseMongo = null;
        public ProvidentFundMongo()
        {
        ...
        public void SaveCityFormSetting(City city)
        {
            ...
            try
            {
                baseMongo.Insert<City>(city, "housingfund_formseting");
            }
            catch (Exception e)
            {
        ...
        public void UpdateCityFormSetting(City city)
        {
            try
            {
                ...
                baseMongo.Remove<City>(query, "housingfund_formseting");
        ...
        public City GetCityFormSetting(string cityCode)
        {
            ...
            try
            {
                ...
                city = baseMongo.FindOne<City>(query, "housingfund_formseting");
            }
            catch (Exception e)
            {
                throw new Exception(e.Message);
