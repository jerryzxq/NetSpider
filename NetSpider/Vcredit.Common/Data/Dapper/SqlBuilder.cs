...
namespace Vcredit.Common
{
    public class SqlBuilder
    {
        ...
        public class Template
        {
            ...
            readonly static System.Text.RegularExpressions.Regex regex = new System.Text.RegularExpressions.Regex(@"\/\*\*.+\*\*\/", System.Text.RegularExpressions.RegexOptions.Compiled | System.Text.RegularExpressions.RegexOptions.Multiline);
            void ResolveSql()
            {
                if (dataSeq != builder.seq)
                {
                    ...
                    {
                        rawSql = rawSql.Replace(String.Format("/**{0}**/", pair.Key), pair.Value.ResolveClauses(p));
                    }
                    parameters = p;
