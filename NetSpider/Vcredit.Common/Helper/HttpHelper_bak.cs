...
namespace Vcredit.Common.Helper
{
    ...
    public class HttpHelper
    {
        ...
        private Stream GetHttpRequestStreamData(HttpItem objhttpitem)
        {
        ...
        private void SetRequest(HttpItem objhttpItem)
        {
            ...
            request.Timeout = objhttpItem.Timeout;//连接网址的超时时间
            request.ReadWriteTimeout = objhttpItem.ReadWriteTimeout;//读取网址内容的超时时间  
        ...
        public Stream GetStream(HttpItem objhttpItem)
        {
            //准备参数
            SetRequest(objhttpItem);
        ...
        public Stream GetStream(string url, ref CookieCollection cookies)
        {
            Stream strm = null;
            try
            {
                ...
                httpreg.CookieContainer = new CookieContainer();
                httpreg.Method = "GET";
                ...
                cookies = httpreg.CookieContainer.GetCookies(req.RequestUri);
            }
            catch (Exception ex)
            {
                return null;
        ...
        public string doGet(string url, ref CookieCollection cookies)
        {
            string result = null;
            try
            {
                ...
                cookies = httpreq.CookieContainer.GetCookies(req.RequestUri);
            }
            catch (Exception ex)
            {
                return "";
        ...
        public Stream PostStream(string action, string data, ref CookieCollection cookies)
        {
            Stream strm = null;
            try
            {
        ...
        public string doPost(string action, string data, ref CookieCollection cookies)
        {
            string result = null;
            try
            {
    ...
    public class HttpItem
    {
        ...
        /// 读取网址内容的超时时间
        /// </summary>
        private int _ReadWriteTimeout = 3000;
