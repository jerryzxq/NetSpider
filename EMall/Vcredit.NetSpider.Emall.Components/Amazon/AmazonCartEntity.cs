...
{
	[Alias("amazon_cart")]
	public class AmazonCartEntity
	{
		public AmazonCartEntity() { }
		...
		{
			get { return productTotalCount; }
			set { productTotalCount = value; }
		}
      
		private decimal? productTotalAmount  ;
        /// <summary>
        /// 产品总价
        /// </summary>
		public decimal? ProductTotalAmount
		{
			get { return productTotalAmount; }
			set { productTotalAmount = value; }
		}
